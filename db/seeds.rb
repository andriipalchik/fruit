...
Fruit.create!([{
    ...
    image: "blueberry",
    gradient_dark: "247FFF",
    gradient_light: "66D6FF",
    ...
    minerals: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Sodium, Zinc"
  },
  {
    title: "Strawberry",
    headline: "Widely appreciated for its characteristic aroma, red color, juicy texture, and sweetness.",
    image: "strawberry",
    gradient_dark: "FF0059",
    gradient_light: "FF809B",
    ...
    fat: "0.3",
    protein: "0.67",
    vitamins: "B1, B2, B3, B5, B6, B9, Choline, C, E, K",
    minerals: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Sodium, Zinc"
  },
  {
    title: "Lemon",
    headline: "There's no doubt lemons are delicious, but does adding them to water make you healthier?",
    image: "lemon",
    gradient_dark: "FFA800",
    gradient_light: "FFF243",
    ...
    minerals: "Calcium, Iron, Magnasium, Manganese, Phosphorus, Potassium, Zinc"
  },
  {
    title: "Plum",
    headline: "Plums are a very nutritious fruit. An excellent source of vitamins, minerals, fiber and antioxidants.",
    image: "plum",
    gradient_dark: "FF183F",
    gradient_light: "FF7A93",
  ...
  },
  {
    ...
    image: "lime",
    gradient_dark: "009443",
    gradient_light: "6BEF67",
    description: "A lime (from French lime, from Arabic līma, from Persian līmū, 'lemon') is a citrus fruit, which is typically round, green in color, 3-6 centimetres (1.2-2.4 in) in diameter, and contains acidic juice vesicles.
  ...
  },
  {
    ...
    headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
    image: "pear",
    gradient_dark: "DA7720",
    gradient_light: "FFC15D",
    description: "The pear (/pɛər/) tree and shrub are a species of genus Pyrus, in the family Rosaceae, bearing the pomaceous fruit of the same name. Several species of pear are valued for their edible fruit and juices while others are cultivated as trees.
  ...
  },
  {
    ...
    headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
    image: "gooseberry",
    gradient_dark: "678A00",
    gradient_light: "DDE366",
    description: "The gooseberry /guzbɛri/ (American), with scientific names Ribes uva-crispa (and syn. Ribes grossularia), is a species of Ribes (which also includes the currants).
  ...
  },
  {
    ...
    headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
    image: "mango",
    gradient_dark: "7CBB00",
    gradient_light: "FFE95C",
  ...
  },
  {
    ...
    headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
    image: "watermelon",
    gradient_dark: "3B9834",
    gradient_light: "84F476",
  ...
  },
  {
    ...
    headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
    image: "grapefruit",
    gradient_dark: "FF8229",
    gradient_light: "FFBD80",
  ...
  },
  {
    ...
    image: "apple",
    gradient_dark: "FF0040",
    gradient_light: "FF8093",
